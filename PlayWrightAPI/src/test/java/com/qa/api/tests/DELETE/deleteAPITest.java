...
public class deleteAPITest extends BaseTest {
	...
	public void createUserTest() throws IOException {
		...
		APIResponse deleteAPIResponse = requestContext.delete("https://gorest.co.in/public/v2/users/" + userID,
				RequestOptions.create().setHeader("Authorization",
						"Bearer e7840d6fb24f862535eb13afe81c6fe786a938fca6470284a87f72e2991e9a75")
		...
		// get the response and check
				...
				APIResponse getAPIResponseAfterDelete= requestContext.get("https://gorest.co.in/public/v2/users/" + userID,
						RequestOptions.create().setHeader("Authorization",
								"Bearer e7840d6fb24f862535eb13afe81c6fe786a938fca6470284a87f72e2991e9a75")
				...
				Assert.assertEquals(getAPIResponseAfterDelete.status(), 404);
				Assert.assertTrue(getAPIResponseAfterDelete.text().contains("Resource not found"));
				System.out.println(getAPIResponseAfterDelete.text());
